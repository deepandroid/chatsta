package com.tridhya.chatsta.loaders
...
import com.tridhya.chatsta.loaders.basicviews.CircleView
import com.tridhya.chatsta.loaders.basicviews.ThreeDotsBaseView
...
class LazyLoader : ThreeDotsBaseView {
    ...
    override fun initAttributes(attrs: AttributeSet) {
        ...
        this.dotsRadius =
            typedArray.getDimensionPixelSize(R.styleable.LazyLoader_lazyloader_dotsRadius, 30)
        this.dotsDist =
        ...
        this.firstDotColor = typedArray.getColor(
            ...
            resources.getColor(R.color.pale_purple)
        )
        ...
        this.firstDelayDuration =
            typedArray.getInt(R.styleable.LazyLoader_lazyloader_firstDelayDur, 100)
        this.secondDelayDuration =
            typedArray.getInt(R.styleable.LazyLoader_lazyloader_secondDelayDur, 200)
