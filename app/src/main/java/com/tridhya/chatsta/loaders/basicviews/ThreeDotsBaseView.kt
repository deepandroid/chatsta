package com.tridhya.chatsta.loaders.basicviews

import android.content.Context
import android.util.AttributeSet
import com.tridhya.chatsta.R
import com.tridhya.chatsta.loaders.contracts.AbstractLinearLayout

abstract class ThreeDotsBaseView : AbstractLinearLayout {

    var firstDotColor: Int = resources.getColor(R.color.pale_purple)

    var secondDotColor: Int = resources.getColor(R.color.pale_purple)

    var thirdDotColor: Int = resources.getColor(R.color.pale_purple)
